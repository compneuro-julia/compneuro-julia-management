- [第1章：はじめに](#第1章はじめに)
  - [本書の目的と構成](#本書の目的と構成)
    - [神経科学における計算論](#神経科学における計算論)
    - [本書の構成](#本書の構成)
  - [Julia言語の使用法](#julia言語の使用法)
    - [Julia言語の特徴](#julia言語の特徴)
    - [Julia言語のインストール方法](#julia言語のインストール方法)
    - [Julia言語の基本構文](#julia言語の基本構文)
  - [基礎的数学とJuliaでの記法](#基礎的数学とjuliaでの記法)
    - [表記法](#表記法)
    - [線形代数](#線形代数)
    - [微分方程式](#微分方程式)
      - [微分方程式の解](#微分方程式の解)
      - [連立線形微分方程式](#連立線形微分方程式)
      - [ラプラス変換](#ラプラス変換)
      - [1階線形行列微分方程式の解](#1階線形行列微分方程式の解)
    - [確率論](#確率論)
      - [期待値 (Expectation)](#期待値-expectation)
      - [情報量 (Information)](#情報量-information)
      - [平均情報量 (エントロピー, entropy)](#平均情報量-エントロピー-entropy)
      - [Kullback-Leibler 情報量](#kullback-leibler-情報量)
      - [相互情報量 (Mutual information)](#相互情報量-mutual-information)
  - [学習に関する基礎的概念](#学習に関する基礎的概念)
    - [モデルと学習・予測](#モデルと学習予測)
    - [回帰と分類](#回帰と分類)
    - [識別モデル・生成モデル](#識別モデル生成モデル)
