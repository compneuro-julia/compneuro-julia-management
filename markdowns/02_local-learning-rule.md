- [第2章：発火率モデルと局所学習則](#第2章発火率モデルと局所学習則)
  ...
  - [独立成分分析](#独立成分分析)
  - [**Step 1: Define the ICA Model**](#step-1-define-the-ica-model)
  - [**Step 2: InfoMax Principle**](#step-2-infomax-principle)
  - [**Step 3: Log-likelihood Function**](#step-3-log-likelihood-function)
  - [**Step 4: Gradient Ascent on Log-Likelihood**](#step-4-gradient-ascent-on-log-likelihood)
  - [**Step 5: Learning Rule**](#step-5-learning-rule)
  - [**Intuition Behind the Learning Rule**](#intuition-behind-the-learning-rule)
