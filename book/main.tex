...
\clearpage
\chapter{はじめに}
% \input{./text/introduction/computational-neuroscience.tex} % ok
% \input{./text/introduction/notation.tex} % ok
% \input{./text/introduction/usage-julia-lang.tex} % ok
% \input{./text/introduction/linear-algebra.tex} % ok
...
\chapter{神経細胞のモデル}
% \input{./text/neuron-model/neuron-physiol.tex} % ok
...
\chapter{局所学習則}
% \input{./text/local-learning-rule/pca-hebbian-learning.tex} % ok2
...
% \input{./text/local-learning-rule/logistic-regression-perceptron.tex} % ok2
