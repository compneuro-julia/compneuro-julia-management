...
入力は，64次元の網膜座標系での位置に2次元の眼球位置信号を加えた66次元のベクトルとする．元のZipser-Andersenモデルにおいては眼球位置信号は活動が単調変化する32ユニット (=8ユニット×2(x, y方向)×2 (傾き正負)) によって符号化されているが，ここでは簡単のために眼球位置信号は $x, y$ の2次元とする．
